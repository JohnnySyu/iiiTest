...
namespace newBlogprj.APIControllers
{
    public class APIController : ApiController
    {
                             ...
                             message = new
                             {
                                 fmessage = from m in db.forumMessageBinding
                                            ...
                                            select new
                                            {
                                                ...
                                                fmegPic = m.forumMemberBinding.memberdb.mb_employeePicture,
        ...
        public JObject Get(int contentid)
        {
            member = lm.getmid(lm.getuserac());
            var result = new
            {
                ...
                ftable = from n in db.forumBinding
                         where n.ForumContentID == contentid
                         select new
                         {
                             chkPoPerson = n.forumMemberBinding.memberdb.mb_ID == member ? true : false,
                             fID = n.forumContent.ForumContentID,
        ...
        public JObject Get(string type)
        {
            ...
            var result = new
            {
                ...
                ftable = from n in db.forumBinding
                         orderby n.forumContent.ForumContentID descending
                         where n.forumContent.ForumDelete != "delete" && n.forumMemberBinding.forumType.ForumTypeID == typeid
                         select new
                         {
                             chkPoPerson = n.forumMemberBinding.memberdb.mb_ID == member ? true : false,
                             fID = n.forumContent.ForumContentID,
